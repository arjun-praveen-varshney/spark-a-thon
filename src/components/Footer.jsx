...
const SocialIcon = ({ children, href = "#" }) => (
  <a className="ml-3 cursor-pointer text-white hover:text-secondary" href={href} target="_blank" rel="noopener noreferrer">
...
const Footer = () => {
  return (
    <footer className="text-white body-font bg-tertiary">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
          <img src={logo} alt="Spark-A-Thon Logo" className="w-10 h-10" />
